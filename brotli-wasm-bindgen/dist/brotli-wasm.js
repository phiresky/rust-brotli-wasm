!(function(e, n) {
    ...
    return (function(e) {
        ...
        (u.e = function(e) {
            ...
            return (
                ({ 0: [7] }[e] || []).forEach(function(e) {
                    var t = o[e];
                    if (t) n.push(t);
                    else {
                        var r,
                            a = i[e](),
                            f = fetch(u.p + "" + { 7: "cba772937489e001bd4e" }[e] + ".module.wasm");
                        if (
                            a instanceof Promise &&
                            "function" == typeof WebAssembly.compileStreaming
                        )
                            r = Promise.all([WebAssembly.compileStreaming(f), a]).then(function(e) {
